...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=14&duration=2800&pause=900&color=58A6FF&center=true&vCenter=true&width=620&height=40&lines=I+build+ML+that+ships.;Ships%2C+scales%2C+stays+honest.;Drift-aware+%C2%B7+cost-tiered+%C2%B7+human-in-the-loop;Six+systems%2C+built+end+to+end)](https://www.esteki.ca)
...
[![P1](https://img.shields.io/badge/PROJECT_01-6366f1?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/posts-to-personas-audience-segmentation.html)
...
[![P2](https://img.shields.io/badge/PROJECT_02-f59e0b?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/wrong-category-call-tagger.html)
...
[![P3](https://img.shields.io/badge/PROJECT_03-0071e3?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/real-time-ml-platform.html)
...
[![P4](https://img.shields.io/badge/PROJECT_04-0d9488?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/amazon-books-rag-llm-search-system.html)
...
[![P5](https://img.shields.io/badge/PROJECT_05-7c3aed?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/omniagent-multi-agent-analytics.html)
...
[![P6](https://img.shields.io/badge/PROJECT_06-e11d48?style=for-the-badge&labelColor=0d1117)](https://www.esteki.ca/projects/symbiote-lite-human-in-loop.html)
...
**[See all six, end to end →](https://www.esteki.ca/projects/index.html)**
...
![MCP](https://img.shields.io/badge/MCP_Protocol-7c3aed?style=flat-square) ![Groq](https://img.shields.io/badge/Groq_LLM-F55036?style=flat-square) `Human-in-the-loop` `Guardrails` `Audit trails` `Shadow mode`

</td></tr>
<tr><td valign="top"><b>📊 Stats & Experiments</b></td><td valign="top">

![R](https://img.shields.io/badge/R-276DC3?style=flat-square&logo=r&logoColor=white) ![Python](https://img.shields.io/badge/Python-3670A0?style=flat-square&logo=python&logoColor=ffdd54) `A/B testing` `Causal inference` `Hypothesis testing`
...
def hooman():
    ...
    system  = wrap(model,                 # the part that makes it survive
                   drift_aware=True,      # PSI fires retraining in <5 min
                   human_in_loop=True,    # asks before it acts
                   validated=True)        # stats prove it is real
    return system.ship()                  # six of these, end to end
```
